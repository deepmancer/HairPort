...
from fit_lmk.camera_utils import get_3x4_P_matrix_ortho, generate_perturbed_cameras
from fit_lmk.segmentation import FaceSegmenter
from fit_lmk.ray_intersector import RayMeshIntersector
from fit_lmk.enhancer_singleton import CodeFormerEnhancerSingleton
...
class MultiViewLandmarkFuser:
    ...
    def process_single_view(
        ...
        if lmk_2d is None:
            lmk_2d = self.landmark_detector.get_lmk_full(image_path)["ldm478"]
