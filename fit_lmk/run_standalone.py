...
def estimate_3d_landmarks_standalone(
    ...
    from fit_lmk.blender_renderer import render_multi_view
...
if __name__ == '__main__':
    ...
    parser.add_argument('--cam_loc', type=float, nargs=3, default=[0.0, -1.45, 0.0])
    parser.add_argument('--cam_rot', type=float, nargs=3, default=[1.5708, 0.0, 0.0])
    parser.add_argument('--ortho_scale', type=float, default=1.1)
    parser.add_argument('--output_dir', type=str, default='./output_landmarks')
    parser.add_argument('--num_perturbations', type=int, default=4)
    parser.add_argument('--angle_range', type=float, default=0.15)
    parser.add_argument('--trans_range', type=float, default=0.05)
